...
class OrvexPayModal extends StatefulWidget {
  final String invoiceId;
  final OrvexClient client;
  ...
  static Future<OrvexPayStatus?> show(
    BuildContext context, {
    required String invoiceId,
    required OrvexClient client,
    VoidCallback? onPaymentSuccess,
    VoidCallback? onPaymentError,
    VoidCallback? onClosed,
  }) {
    return showModalBottomSheet<OrvexPayStatus>(
      context: context,
      isScrollControlled: true,
      backgroundColor: Colors.transparent,
      builder: (context) => OrvexPayModal(
        invoiceId: invoiceId,
        client: client,
  ...
  @override
  State<OrvexPayModal> createState() => _OrvexPayModalState();
}

class _OrvexPayModalState extends State<OrvexPayModal> {
  Invoice? _invoice;
  ...
  final List<Map<String, String>> _coins = [
    ...
    {'code': 'AVAX', 'name': 'Avalanche', 'network': 'C-Chain'},
    {'code': 'ARB', 'name': 'Arbitrum', 'network': 'Arbitrum One'},
    {'code': 'OP', 'name': 'Optimism', 'network': 'Optimism'},
    {'code': 'BASE', 'name': 'Base', 'network': 'Base'},
    {'code': 'FTM', 'name': 'Fantom', 'network': 'Fantom'},
    {'code': 'XLM', 'name': 'Stellar', 'network': 'Stellar'},
    {'code': 'ALGO', 'name': 'Algorand', 'network': 'Algorand'},
    {'code': 'NEAR', 'name': 'Near', 'network': 'Near'},
    {'code': 'EOS', 'name': 'EOS', 'network': 'EOS'},
  ...
  Future<void> _fetchInvoice({bool isPolling = false}) async {
    try {
      ...
      if (mounted) {
        ...
        if (invoice.status == 'Finished' ||
          ...
          Future.delayed(const Duration(seconds: 3), () {
            if (mounted) {
              Navigator.pop(context, OrvexPayStatus.success);
            }
          });
        }
      }
      ...
      if (!isPolling && mounted) {
        ...
        // Navigator.pop(context, OrvexPayStatus.error);
      }
    }
  }
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.pop(context, OrvexPayStatus.cancelled);
                  },
                ),
              ],
            ),
